    ...
    $("#searchCount").click(function() {
    	...
    	parent.$('#bbody').layout('add',{
    	    ...
    	    tools: [{
    			iconCls:'icon-reload',
    			handler:function(){
    				parent.$('#easst').panel('refresh', 'getCheckInCount');
    			}
    	    }],
    	});
...
<!-- 	<div style="margin: 20px 0;"></div> -->
    <div id="toolbar">
     ...
     <button id="searchCount">查询签到人数</button>
    </div>
	...
	<table class="easyui-datagrid" id="list_data" 
		...
		<thead>
			<tr>
				...
				<th data-options="field:'level',width:'auto'">签到等级</th>
				<th data-options="field:'score',width:'auto'">得到点币</th>
				<th data-options="field:'allscore',width:'auto'">总点币</th>
