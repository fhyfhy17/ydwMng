...
//             singleSelect:true,//为true时只能选择单行
    ...
    $("#searchSum").click(function() {
    	...
    	var content = '<iframe scrolling="auto" frameborder="0"  src="'+"jsp/getScoreBuySum.jsp?"+par+'" style="width:100%;height:100%;"></iframe>';
...
<!-- 	<div style="margin: 20px 0;"></div> -->
    <div id="toolbar">
     ...
     <button id="search">查询</button>
      <button id="searchSum">查询汇总</button>
	...
	<table class="easyui-datagrid" id="list_data" 
		...
		<thead>
			<tr>
				...
				<th data-options="field:'allscore',width:'auto',align:'right'">剩余总积分</th>
				<th data-options="field:'scoreitemindex',width:'auto'">兑换物品序号</th>
				<th data-options="field:'scoreitemname',width:'auto',align:'center'">兑换物品名字</th>
				<th data-options="field:'scoreprice',width:'auto',align:'center'">兑换物品价格</th>
